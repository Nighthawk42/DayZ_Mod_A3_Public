////////////////////////////////////////////////////////////////////
//DeRap: dayz_equip\config.bin
//Produced from mikero's Dos Tools Dll version 6.94
//https://armaservices.maverick-applications.com/Products/MikerosDosTools/default
//'now' is Mon Jan 13 22:55:21 2020 : 'file' last modified on Mon Jul 09 16:16:33 2012
////////////////////////////////////////////////////////////////////
...
class CfgVehicles
{
	...
	class BearTrap_DZ: TrapItems
	{
		...
		class Eventhandlers
		{
			init = "_this execFSM '\dayz_code\system\trap_monitor.fsm';";
		};
	...
	class WeaponHolder_Colt1911: WeaponHolderBase
	{
		...
		class eventHandlers
		{
			init = "[(_this select 0),'cfgWeapons','Colt1911'] execVM '\dayz_code\init\object_pickupAction.sqf';";
		};
	};
	class WeaponHolder_ItemHatchet: WeaponHolderBase
	{
		...
		class eventHandlers
		{
			init = "[(_this select 0),'cfgWeapons','ItemHatchet'] execVM '\dayz_code\init\object_pickupAction.sqf';";
		};
	};
	class WeaponHolder_MeleeCrowbar: WeaponHolderBase
	{
		...
		class eventHandlers
		{
			init = "[(_this select 0),'cfgWeapons','MeleeCrowbar'] execVM '\dayz_code\init\object_pickupAction.sqf';";
		};
	};
	class WeaponHolder_huntingrifle: WeaponHolderBase
	{
		...
		class eventHandlers
		{
			init = "[(_this select 0),'cfgWeapons','huntingrifle'] execVM '\dayz_code\init\object_pickupAction.sqf';";
		};
	};
	class WeaponHolder_M4A1: WeaponHolderBase
	{
		...
		class eventHandlers
		{
			init = "[(_this select 0),'cfgWeapons','M4A1'] execVM '\dayz_code\init\object_pickupAction.sqf';";
		};
	};
	class WeaponHolder_ItemTent: WeaponHolderBase
	{
		...
		class eventHandlers
		{
			init = "[(_this select 0),'cfgMagazines','ItemTent'] execVM '\dayz_code\init\object_pickupAction.sqf';";
		};
	};
	class WeaponHolder_ItemFlashlight: WeaponHolderBase
	{
		...
		class eventHandlers
		{
			init = "[(_this select 0),'cfgWeapons','ItemFlashlight'] execVM '\dayz_code\init\object_pickupAction.sqf';";
		};
	};
	class WeaponHolder_ItemFlashlightRed: WeaponHolderBase
	{
		...
		class eventHandlers
		{
			init = "[(_this select 0),'cfgWeapons','ItemFlashlightRed'] execVM '\dayz_code\init\object_pickupAction.sqf';";
		};
	};
	class WeaponHolder_ItemWaterbottle: WeaponHolderBase
	{
		...
		class eventHandlers
		{
			init = "[(_this select 0),'cfgMagazines','ItemWaterbottleUnfilled'] execVM '\dayz_code\init\object_pickupAction.sqf';";
		};
	};
	class WeaponHolder_ItemGenerator: WeaponHolderBase
	{
		...
		class eventHandlers
		{
			init = "[(_this select 0),'cfgMagazines','ItemGenerator'] execVM '\dayz_code\init\object_generator.sqf';";
		};
	};
	class WeaponHolder_ItemToolbox: WeaponHolderBase
	{
		...
		class eventHandlers
		{
			init = "[(_this select 0),'cfgWeapons','ItemToolbox'] execVM '\dayz_code\init\object_pickupAction.sqf';";
		};
	};
	class WeaponHolder_PartFueltank: WeaponHolderBase
	{
		...
		class eventHandlers
		{
			init = "[(_this select 0),'cfgMagazines','PartFueltank'] execVM '\dayz_code\init\object_pickupAction.sqf';";
		};
	};
	class WeaponHolder_PartWheel: WeaponHolderBase
	{
		...
		class eventHandlers
		{
			init = "[(_this select 0),'cfgMagazines','PartWheel'] execVM '\dayz_code\init\object_pickupAction.sqf';";
		};
	};
	class WeaponHolder_PartGeneric: WeaponHolderBase
	{
		...
		class eventHandlers
		{
			init = "[(_this select 0),'cfgMagazines','PartGeneric'] execVM '\dayz_code\init\object_pickupAction.sqf';";
		};
	};
	class WeaponHolder_PartVRotor: WeaponHolderBase
	{
		...
		class eventHandlers
		{
			init = "[(_this select 0),'cfgMagazines','PartVRotor'] execVM '\dayz_code\init\object_pickupAction.sqf';";
		};
	};
	class WeaponHolder_PartEngine: WeaponHolderBase
	{
		...
		class eventHandlers
		{
			init = "[(_this select 0),'cfgMagazines','PartEngine'] execVM '\dayz_code\init\object_pickupAction.sqf';";
		};
	};
	class WeaponHolder_PartGlass: WeaponHolderBase
	{
		...
		class eventHandlers
		{
			init = "[(_this select 0),'cfgMagazines','PartGlass'] execVM '\dayz_code\init\object_pickupAction.sqf';";
		};
	};
	class WeaponHolder_ItemJerrycan: WeaponHolderBase
	{
		...
		class eventHandlers
		{
			init = "[(_this select 0),'cfgMagazines','ItemJerrycan'] execVM '\dayz_code\init\object_pickupAction.sqf';";
		};
	};
