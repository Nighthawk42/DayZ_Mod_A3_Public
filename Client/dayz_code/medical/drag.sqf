...
[_dragee,"\dayz_code\medical\publicEH\animDrag.sqf"] remoteExec ["execVM",-2];
...
//NORRN_carryAction = player addAction ["Carry body", "\dayz_code\medical\carry.sqf",_dragee, 0, false, true];
sleep 1;
