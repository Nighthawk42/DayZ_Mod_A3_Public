...
switch (_item) do {
	case "ItemBandage": {
		_id = [0,0,0,[player]] execVM "\dayz_code\medical\bandage.sqf";
	};
	case "ItemMorphine": {
		_id = [0,0,0,[player]] execVM "\dayz_code\medical\morphine.sqf";
	};
	case "ItemPainkiller": {
		_id = [0,0,0,[player]] execVM "\dayz_code\medical\painkiller.sqf";
	};
	case "ItemAntibiotic": {
		_id = [0,0,0,[player]] execVM "\dayz_code\medical\antibiotics.sqf";
	};
	case "ItemHeatPack": {
