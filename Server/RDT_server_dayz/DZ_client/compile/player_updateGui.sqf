...
if (_bloodLvl <= 0) then { 
	_blood = "\DayZ_code\gui\status_blood_inside_1_ca.paa";
} else {
	_blood = "\DayZ_code\gui\status_blood_inside_" + str(_bloodLvl) + "_ca.paa";
};

if (_thirstLvl < 0) then { _thirstLvl = 0 };
_thirst = "\DayZ_code\gui\status_thirst_inside_" + str(_thirstLvl) + "_ca.paa";

if (_foodLvl < 0) then { _foodLvl = 0 };
_food = "\DayZ_code\gui\status_food_inside_" + str(_foodLvl) + "_ca.paa";
...
_temp = "\DayZ_code\gui\status_temp_" + str(_tempImg) + "_ca.paa";
...
if (_visual > 0) then {_visualtext = "\DayZ_code\gui\val_" + str(_visual) + "_ca.paa"};
...
if (_audible > 0) then {_audibletext = "\DayZ_code\gui\val_" + str(_audible) + "_ca.paa"};
...
if(_humanity != dayz_lastHumanity) then {
	...
	_humanityText = "\DayZ_code\gui\humanity_" + str(_guiHumanity) + "_ca.paa";
