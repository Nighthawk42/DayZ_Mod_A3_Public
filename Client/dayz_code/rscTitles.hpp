...
class RscTitles
{
	...
	class playerKillScore 
	{
		...
		class ControlsBackground {
			...
			{
				idc = 1400;
				text = "\dayz_code\gui\stats_kills_human_ca.paa";
			...
			{
				idc = 1401;
				text = "\dayz_code\gui\stats_kills_zombie_ca.paa";
				x = 0.044687 * safezoneW + safezoneX;
	...
	class playerStatusWaiting
	{
		...
		class Controls {
			...
			{
				idc = 1401;
				text = "\dayz_code\gui\status_waiting_ca.paa";
	...
	class playerStatusGUI
	{
		...
		class ControlsBackground {
			...
			{
				idc = 1201;
				text = "\dayz_code\gui\status_food_border_ca.paa";
			...
			{
				idc = 1200;
				text = "\dayz_code\gui\status_blood_border_ca.paa";
				x = 0.955313 * safezoneW + safezoneX;
			...
			{
				idc = 1202;
				text = "\dayz_code\gui\status_thirst_border_ca.paa";
				x = 0.955313 * safezoneW + safezoneX;
			...
			{
				idc = 1208;
				text = "\dayz_code\gui\status_temp_outside_ca.paa";
				x = 0.955313 * safezoneW + safezoneX;
			...
			class RscPicture_1207 : RscPictureGUI {
				idc = 1207;
				text = "\dayz_code\gui\status_combat_border_ca.paa";
				x = "0.955313 * safezoneW + safezoneX";
			...
			{
				idc = 1203;
				text = "\dayz_code\gui\status_fracture_ca.paa";
				x = 0.955313 * safezoneW + safezoneX;
			...
			{
				idc = 1204;
				text = "\dayz_code\gui\status_connection_ca.paa";
				x = 0.955313 * safezoneW + safezoneX;
			...
			{
				idc = 1205;
				text = "\dayz_code\gui\status_ear_ca.paa";
				x = 0.955313 * safezoneW + safezoneX;
			...
			{
				idc = 1206;
				text = "\dayz_code\gui\status_eye_ca.paa";
				x = 0.955313 * safezoneW + safezoneX;
		...
		class Controls{
			...
			{
				idc = 1301;
				//text = "\dayz_code\gui\status_food_inside_ca.paa";
				x = 0.955313 * safezoneW + safezoneX;
			...
			{
				idc = 1300;
				//text = "\dayz_code\gui\status_blood_inside_ca.paa";
				x = 0.955313 * safezoneW + safezoneX;
			...
			{
				idc = 1302;
				//text = "\dayz_code\gui\status_thirst_inside_ca.paa";
				x = 0.955313 * safezoneW + safezoneX;
			...
			{
				idc = 1306;
				//text = "\dayz_code\gui\status_temp_ca.paa";
				x = 0.955313 * safezoneW + safezoneX;
			...
			{
				idc = 1303;
				text = "\dayz_code\gui\status_bleeding_ca.paa";
				x = 0.955313 * safezoneW + safezoneX;
				y = 0.86 * safezoneH + safezoneY;
				w = 0.06;
				h = 0.08;
			...
			class RscPicture_1307 : RscPictureGUI {
				idc = 1307;
				text = "\dayz_code\gui\status_combat_inside_ca.paa";
				x = "0.955313 * safezoneW + safezoneX";
				y = "0.65 * safezoneH + safezoneY";
				w = 0.06;
				h = 0.08;
